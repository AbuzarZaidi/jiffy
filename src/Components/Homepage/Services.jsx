  ...
  return (
    ...
    <Grid container className={classes.ht}>
        ...
        <Grid item xs={12} md={12} lg={12} className={classes.services_desc}>
            <Grid item xs={6} md={3} lg={3} className={classes.services_content}>
                <div>
            ...
            <div className={classes.services_heading}>Package <br/>Delivery</div>
            <div className={classes.services_details}>
            ...
            <Grid item xs={6} md={3} lg={3} sm={3}>
            <div>
                    <img src='./Images/ip.svg' className={classes.package}></img>
                </div>
            <div className={classes.services_heading}>Document <br/>Attestation</div>
            <div className={classes.services_details}>
