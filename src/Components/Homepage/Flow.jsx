...
const Flow = (props) =>{
    const { classes } = props;
  return (
    <Grid item xs={12} container className={classes.flow}>
        ...
        <Grid item xs={12} md={12} lg={12} className={classes.services_desc}>
            ...
            <div className={classes.flow_heading}>Input<br/> Details</div>
            <div className={classes.services_details}>
            ...
            <div className={classes.flow_heading}>Live <br/>Tracking</div>
            <div className={classes.services_details}>
            ...
            <div className={classes.flow_heading}>Authenticated <br/>Delivery</div>
            <div className={classes.services_details}>
