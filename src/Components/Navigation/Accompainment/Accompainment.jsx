      ...
      <OutlinedInput
        ...
        endAdornment={
          ...
          >
            ...
            <ToggleButton className="toggledts" value="PM">
              PM
            </ToggleButton>
          </ToggleButtonGroup>
        }
        ...
        <Grid container className={classes.newbg}>
              ...
              <Grid container className={classes.send_bg}>
                <Grid item xs={10} md={5} lg={5}>
                  <div className={classes.heading}>
                    <img
                      className={classes.accomo_send_img}
                      src="./Images/aa.png"
                      onClick={() => goback()}
                    ></img>
                    &nbsp;&nbsp;
                ...
                <Grid item xs={2} md={7} lg={7}>
                  <div className={classes.accomo_send_header}>
          ...
          <TabsUnstyled defaultValue={0} className={classes.ht}>
            ...
            <TabPanel value={0}>
              ...
              <div className={classes.will}>
                We will assign the nearest counter to pick up and deliver as
                soon as possible
              </div>
          ...
          <p className={alignmentTrans === 'bike' ? classes.four_wheel : classes.four_wheel_active}>4 Wheeler</p>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className={classes.content1}>
                  <div className={classes.send_label}>Drop Off Address</div>
                  <div className={classes.content}>
                    <Grid container spacing={2}>
                      <Grid item xs={11} md={10} lg={12}>
                        <FormControl
