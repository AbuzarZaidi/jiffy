...
const ScheduleAccompainment = (props) => {
  ...
  const handleSubmit = event => {
    ...
    params["rule"] = "accompainmentScheduleLater"
        ...
        <Grid item xs={12} md={12} lg={12}>
          ...
          <p className={alignmentTrans === 'bike' ? classes.four_wheel : classes.four_wheel_active}>4 Wheeler</p>
           ...
           {/*} <p className={classes.revert}><b>Select based on your requirement :</b></p> &nbsp;
            <p className={classes.two_wheel_inactive}>2 Wheeler</p>
            <div className={classes.del_icon}>
          
              <img src='./Images/biked.svg' className={classes.biked_inactive} width={41} height={31}></img>&nbsp;
            </div>
            <SwitchUnstyled component={Root} defaultChecked />
            <img src='./Images/sedan.png' height={60}></img>&nbsp;
  <p className={classes.four_wheel_active}>4 Wheeler</p>*/}
