                      ...
                      <Box className={classes.delivery} key={index} >
                        {item.order_status === "Delivery Request Accepted" || item.order_status === "pickedup" ? (
                          <div className={classes.courierInfoContainer} >
                            <p className={classes.courierInfo}>Courier has been assigned<span className={classes.courierDetail}> &nbsp;|&nbsp; Delivery agent on Jiffy platform should arrive around {item.pickupTime} </span> <u className={classes.courier} onClick={() => gotoTrack(index)} >Track courier</u></p>
                            {show ? (<MapComponent  items={item} 
                        ...
                        <Grid item xs={12} md={12} lg={12} className={classes.stepper1}>
                          ...
                          <Grid item xs={12} md={10} lg={10} className={classes.ddpick}>
                            ...
                            <span className={classes.lpickData}>P.O. Box {item.pickup_location} &nbsp;{/*<u className={classes.modifyButton}>Modify</u><span className={classes.modifyButton}> / </span><u className={classes.modifyButton}>Reschedule</u>*/}</span><br /> <br />
                        ...
                        <Grid item xs={12} md={12} lg={12} className={classes.stepper}>
                          <div className={classes.contact}>
                            <b className={classes.courierTitle}>Courier Details</b>
                          </div>
                        ...
                        <Grid item xs={12} md={12} lg={12} className={classes.stepper3}>
                          ...
                          <button className={classes.modify}>Reschedule</button>
