...
const ScheduleDocument = (props) => {
  ...
  const handleSubmit = event => {
    ...
    params["pickup_location"] = event.target[3].value
    params["pickup_location_phone"] = event.target[5].value
    params["pickupEmail"] = event.target[7].value
    params["pickupTime"] = event.target[9].value
    params["pickupTimeDesc"] = alignment
    params["pickup_instruction"] = event.target[13].value
    params["delivery_location"] = event.target[15].value
    params["delivery_location_phone"] = event.target[17].value
    params["deliveryEmail"] = event.target[19].value
    params["deliveryTime"] = event.target[21].value
    params["deliveryTimeDesc"] = alignmentDel
    params["delivery_instruction"] = event.target[25].value
    ...
    params["delivery_type"] = "documentattestlater"
  ...
  const DatePickerInput = forwardRef(({ value, onClick }, ref) => (
    <OutlinedInput
      ...
      value={value}
      ref={ref}
      startAdornment={<InputAdornment position="start"><Typography className={classes.selectDateText}>Select Date</Typography></InputAdornment>}
      aria-describedby="outlined-weight-helper-text"
      inputProps={{
        'aria-label': 'weight',
      }}
      endAdornment={<InputAdornment position="end"><img src='./Images/calendar-alt-bold.png' /></InputAdornment>}
      labelWidth={0}
  ...
  const { error1, error2, error3, error4, error5 } = props
          ...
          <form onSubmit={handleSubmit}>
            <div className={classes.content1}>
              ...
              <div className={classes.content}>
                <Grid container spacing={2}>
                  <Grid container item md={12} lg={12} alignItems="center" className={classes.pickUpDateContainer}>
                  <ToggleButton
                      className={clsx('toggledts1', 'toggle-button-left')}
                        value="check1"
                        selected={selected4}
                        //onClick={updatedate}
                        onChange={() => {
            ...
            {/*} <div className={classes.content1}>
              ...
              <div className={classes.content}>
                ...
                <p className={classes.weightWarning}>Price varies based on the Kilograms you select</p>
              </div>
            </div>*/}
             ...
             <div className={classes.content1A} onClick={getArrowDown}>
                ...
                />*/}
                      ...
                      <Grid item xs={11} md={12} lg={4}>
                        <DatePicker
                          selected={pickup2}
                          onChange={(date,event) => setDesc2(date,event)}
            ...
            <div className={classes.content1}>
                  ...
                  <Grid item xs={12} md={3} lg={3}>
                     ...
                     <ToggleButton
                      ...
                      >
                        <CheckIcon />
                      </ToggleButton>&nbsp;&nbsp;&nbsp;&nbsp; <span className={classes.prefer}>A4 envelope (2 AED)</span>
                      </Grid>
                    </Grid>
            ...
            {/*} <div className={classes.content}>
                    <Grid container spacing={3}>
                      ...
                      <Grid item md={4} lg={4} >
                        ...
                        <p>0 AED : Additional charges for securing parcel</p>
                        <p>Secure your important packages to retrieve the value in case of loss or damage done during delivery. Valid upto AED 5000.</p>
...
export default withStyles(SendPackageStyle)(ScheduleDocument);
