...
const ScheduleLater = (props) => {
  ...
  const handleSubmit = (event) => {
    ...
    params["delivery_type"] = "personalisedScheduleLater"
    ...
    params["rule"] = "personalisedScheduleLater";
      ...
      <Grid container>
        <Grid item xs={12} md={12} lg={12}>
          <div className={classes.will}>
            We will assign the nearest delivery agent to pick up and deliver as
            soon as possible
          </div>
          <div className={classes.req}>
            <p className={classes.revert}>
              <b className={classes.reqi2}>Select based on your requirement :</b>
              <p
                className={
                  alignmentTrans === "bike"
                    ? classes.two_wheel2
                    : classes.two_wheel_inactive2
                }
              >
                <b>2 Wheeler</b>
              </p>
                ...
                <Grid container spacing={2} >
                  ...
                  >
                    ...
                    minDate={moment().toDate()}
                      ...
                      class={classes.selectDatePersonalize}
                    />
                  </Grid>
                </Grid>
              </div>
                      ...
                      {(popupState) => (
                        <React.Fragment>
                          ...
                          >
                            ...
                            <MenuItem className="dropnew">
                              <span className="valdet">Birth Certificate</span>
                              <div className="passd">
                                <IconButton
                            ...
                            <MenuItem className="dropnew">
                              <span className="valdet">Degree Certificate</span>
                              <div className="passd">
                                <IconButton
                  ...
                  <Grid item md={6} lg={6}>
                    <div className={classes.total}>
                      ...
                      <img
                        ...
                        src="./Images/info.svg"
                      ></img>
                      <b className={classes.price_tag}>&nbsp;&nbsp;{price}</b>
                      &nbsp;AED
                    </div>
                  </Grid>
                ) : (
...
export default withStyles(SendPackageStyle)(ScheduleLater);
