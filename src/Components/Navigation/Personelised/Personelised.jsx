...
const Personelised = (props) => {
  ...
  const handleSubmit = (event) => {
    ...
    pDetails["pickup_longitude"] = String(coordinate.long);
    ...
    params["delivery_type"] = "personalisedDeliverNow"
            ...
            <Grid container className={classes.ht}>
              ...
              <Grid item xs={8} md={7} lg={7}> 
                  <div className={classes.heading}>
                    <img className={classes.accomo_send_img} src='./Images/il.svg' onClick={() => goback()}></img>&nbsp;&nbsp;
                    <div className={classes.send_heading}>  Personalized
Services</div>
                  </div>
                </Grid>
          ...
          <TabsUnstyled defaultValue={0} className={classes.ht}>
             ...
             */}{" "}
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className={classes.content1}>
                  <div className={classes.itemLabel}>Service Information</div>
...
export default withStyles(SendPackageStyle)(Personelised);
