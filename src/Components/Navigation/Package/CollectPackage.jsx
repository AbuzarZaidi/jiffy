...
const CollectPackage = (props) => {
  ...
  const handleSubmit = (event) => {
    ...
    params["delivery_type"] = "collectnow"
  ...
  const handleSelectDelivery = async (value) => {
    ...
    priceParams["delivery_type"] = "collectnow";
              ...
              <Grid container className={classes.send_bg} >
                <Grid item xs={5} md={5} lg={5}>
                  <div className={classes.heading}>
                    ...
                    <div className={classes.send_heading}>  Collect Package</div>
                  </div>
                </Grid>
...
export default withStyles(SendPackageStyle)(CollectPackage);
